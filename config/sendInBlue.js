                            ...
                            <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                <td class="logo"
                                    ...
                                    <h1
                                        ...
                                        <a href="#"
                                            style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #c742f0;font-size: 24px;font-weight: 700;font-family: 'Lato', sans-serif;">AMB</a>
                                    </h1>
                                </td>
                            </tr>
                        </table>
                                ...
                                <td
                                    ...
                                    <div class="text"
                                        ...
                                        <h2
                                            ...
                                            <span
                                                style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-weight: 600;color: #c742f0;">${code}</span>
                                        </h2>
                                    </div>
                                </td>
                            </tr>
